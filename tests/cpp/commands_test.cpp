...
// The raw-buffer scanners has_status_value() /
// is_lacking_properties_response() were removed with the structured
// status capture — their wire-format edge cases now live in
// protocol_test.cpp as parser-level status/lacking_properties tests.
